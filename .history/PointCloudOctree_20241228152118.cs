...
namespace PointCloudViewer
{
    ...
    //         }
    //     }
        public PointCloudNode(Vector3d minv, Vector3d maxv, PointCloudColorMapper colorMapper, string colorType) {
            this.minCoordinate = minv;
            this.maxCoordinate = maxv;
        ...
        public void InsertPointToNode(ColorPoint point)
        {
            ...
            else
            {
                ...
                if (childNode[index] == null)
                {
                    ...
                    // childNode[index] = new PointCloudNode(0, ref dataIndex, ref data, ref minva, ref maxva, pointCloudColorMapper, pointCloudColor);childNode[index] = new PointCloudNode(0, ref dataIndex, ref data, ref minva, ref maxva, pointCloudColorMapper, pointCloudColor);
                }
    ...
    internal class PointCloudOctree : IDisposable
    {
            ...
            ref Vector3d minv, ref Vector3d maxv, PointCloudColorMapper pointCloudColorMapper, string colorType = "RGB")
        {
            ...
            _root = new PointCloudNode(minv, maxv, pointCloudColorMapper, colorType);
        }
